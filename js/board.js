...
var proj = function (_layerBorad, _layerBg, _layerTheme, _layerTheme2, _layerDots, _layerLines, x, y) {
    this.radius = 6;
    this.xBorder = 20;
    this.yBorder = 20;
    this.drawingWidth = 1;
...
proj.prototype.DrawALineOnClick = function (e) {    
    ...
    xClick = getCursorPosition(e)[0] - this.canvasOffsetLeft;
    yClick = getCursorPosition(e)[1] - this.canvasOffsetTop;
...
proj.prototype.drawRandom = function (r1, r2, color) {
    takeLine(0, 0);
};
